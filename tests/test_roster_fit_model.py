...
def player_profiles():
    ...
    return pd.DataFrame([
        {"player_id": "p1", "player_name": "Alice", "position": "WR",
         "position_group": "WR", "season": 2021,
         "speed_score": 1.2, "agility_score": 0.8, "burst_score": 0.5,
         "nfl_production_score": 0.9, "target_share": 0.25, "snap_share": 0.7,
         "epa_per_game": 0.3},
        {"player_id": "p2", "player_name": "Bob", "position": "WR",
         "position_group": "WR", "season": 2021,
         "speed_score": -0.5, "agility_score": 1.1, "burst_score": 0.2,
         "nfl_production_score": 0.4, "target_share": 0.15, "snap_share": 0.5,
         "epa_per_game": 0.1},
        {"player_id": "p1", "player_name": "Alice", "position": "WR",
         "position_group": "WR", "season": 2022,
         "speed_score": 1.2, "agility_score": 0.8, "burst_score": 0.5,
         "nfl_production_score": 0.9, "target_share": 0.25, "snap_share": 0.7,
         "epa_per_game": 0.3},
        {"player_id": "p2", "player_name": "Bob", "position": "WR",
...
def team_profiles():
    return pd.DataFrame([
        {"team": "SF", "season": 2022,
         "air_yards_scheme": 1.0, "yac_scheme": 0.5, "pass_rate": 0.6,
         "pass_epa_efficiency": 0.8, "run_epa_efficiency": 0.3,
         "def_pass_scheme": 0.4, "def_run_scheme": 0.5,
         "run_success_rate": 0.5, "pass_success_rate": 0.6},
        {"team": "KC", "season": 2022,
         "air_yards_scheme": 0.3, "yac_scheme": 1.2, "pass_rate": 0.7,
         "pass_epa_efficiency": 1.1, "run_epa_efficiency": 0.2,
         "def_pass_scheme": 0.6, "def_run_scheme": 0.3,
         "run_success_rate": 0.4, "pass_success_rate": 0.7},
    ])
...
def outcomes_df():
    return pd.DataFrame([
        ...
        {"player_id": "p2", "team": "KC", "join_season": 2022, "production_z": -0.2},
    ])
